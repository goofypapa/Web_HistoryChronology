...
// t_parameter3.targetId = ""+that.name+"///"+galleryTop.realIndex,
// t_parameter3.targetType = "earthApp"
// goofypapaPost( "http://www.dadpat.com/dynasty/getAllList.do", {}, function( p_res ){
//     // alert(JSON.stringify(p_res) +'在轮播时判断是否收藏')
//
//     alert(p_res.data);
//     var datas = p_res.data;
